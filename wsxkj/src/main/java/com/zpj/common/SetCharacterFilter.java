...
//			//手机请求
			if(str_href.indexOf("app")>-1){
				if(str_href.indexOf("app/login")>-1||str_href.indexOf("app/file")>-1||str_href.indexOf("v1_1_0/findGoodsByIdH5")>-1||str_href.indexOf("v1_1_0/searchGoodsListH5")>-1||str_href.indexOf("v1_1_0/findShopNameByUseridH5")>-1){
					chain.doFilter(request, response);
				}else{
